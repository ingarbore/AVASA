      ...
      <cp:CadastralParcel gml:id="ES.LOCAL.CP.T5_CEN_0220-1">
         ...
         <cp:geometry>
           <gml:MultiSurface gml:id="MultiSurface_ES.LOCAL.CP.T5_CEN_0220-1" srsName="urn:ogc:def:crs:EPSG:4326"> 
                <gml:surfaceMember>
               <gml:Surface gml:id="Surface_ES.LOCAL.CP.T5_CEN_0220-1.Polygon_1" srsName="urn:ogc:def:crs:EPSG:4326">
                  <gml:patches>
                    <gml:PolygonPatch>
                        <gml:exterior>
                        <gml:LinearRing>
...
-2.66076914685 42.4786526269
            ...
            <base:Identifier>
            <base:localId>T5_CEN_0220-1</base:localId>
            <base:namespace>ES.LOCAL.CP</base:namespace>
            </base:Identifier>
            </cp:inspireId>
      <cp:label>T5_CEN_0220-1</cp:label>
      <cp:nationalCadastralReference>T5_CEN_0220-1</cp:nationalCadastralReference>
      </cp:CadastralParcel>
   </gml:featureMember>
