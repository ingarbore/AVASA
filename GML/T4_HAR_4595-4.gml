...
<gml:FeatureCollection xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:cp="urn:x-inspire:specification:gmlas:CadastralParcels:3.0" xmlns:base="urn:x-inspire:specification:gmlas:BaseTypes:3.2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:x-inspire:specification:gmlas:CadastralParcels:3.0 http://inspire.ec.europa.eu/schemas/cp/3.0/CadastralParcels.xsd" gml:id="ES.LOCAL.CP">
   <gml:featureMember>
      <cp:CadastralParcel gml:id="ES.LOCAL.CP.T4_HAR_4595-4">
         <cp:areaValue uom="m2">2.89044472029e-08</cp:areaValue>
         <cp:beginLifespanVersion xsi:nil="true" nilReason="other:unpopulated"></cp:beginLifespanVersion>
         <cp:geometry>
           <gml:MultiSurface gml:id="MultiSurface_ES.LOCAL.CP.T4_HAR_4595-4" srsName="urn:ogc:def:crs:EPSG:4326"> 
                <gml:surfaceMember>
               <gml:Surface gml:id="Surface_ES.LOCAL.CP.T4_HAR_4595-4.Polygon_1" srsName="urn:ogc:def:crs:EPSG:4326">
                  <gml:patches>
                    <gml:PolygonPatch>
                        <gml:exterior>
                        <gml:LinearRing>
                        <gml:posList srsDimension="2" count="12">
-2.87060644764 42.5813883566
-2.87063871282 42.5813617989
-2.87070393637 42.5814326242
-2.8707409979 42.5814750092
-2.87090135631 42.5816584004
-2.87101035316 42.581780364
-2.87102150706 42.5817928448
-2.87110128931 42.5818849154
-2.87106949498 42.5819072643
-2.87085772476 42.5816720581
-2.87065721457 42.5814438797
-2.87060644764 42.5813883566
                        </gml:posList>
                        </gml:LinearRing>
                        </gml:exterior>
            ...
            <base:Identifier>
            <base:localId>T4_HAR_4595-4</base:localId>
            <base:namespace>ES.LOCAL.CP</base:namespace>
            </base:Identifier>
            </cp:inspireId>
      <cp:label>T4_HAR_4595-4</cp:label>
      <cp:nationalCadastralReference>T4_HAR_4595-4</cp:nationalCadastralReference>
      </cp:CadastralParcel>
   </gml:featureMember>
