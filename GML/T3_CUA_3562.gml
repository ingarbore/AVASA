...
<gml:FeatureCollection xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:cp="urn:x-inspire:specification:gmlas:CadastralParcels:3.0" xmlns:base="urn:x-inspire:specification:gmlas:BaseTypes:3.2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:x-inspire:specification:gmlas:CadastralParcels:3.0 http://inspire.ec.europa.eu/schemas/cp/3.0/CadastralParcels.xsd" gml:id="ES.LOCAL.CP">
   <gml:featureMember>
      <cp:CadastralParcel gml:id="ES.LOCAL.CP.T3_CUA_3562">
         <cp:areaValue uom="m2">6.42922165565e-08</cp:areaValue>
         <cp:beginLifespanVersion xsi:nil="true" nilReason="other:unpopulated"></cp:beginLifespanVersion>
         <cp:geometry>
           <gml:MultiSurface gml:id="MultiSurface_ES.LOCAL.CP.T3_CUA_3562" srsName="urn:ogc:def:crs:EPSG:4326"> 
                <gml:surfaceMember>
               <gml:Surface gml:id="Surface_ES.LOCAL.CP.T3_CUA_3562.Polygon_1" srsName="urn:ogc:def:crs:EPSG:4326">
                  <gml:patches>
                    <gml:PolygonPatch>
                        <gml:exterior>
                        <gml:LinearRing>
                        <gml:posList srsDimension="2" count="8">
-2.89594017325 42.8970493968
-2.89587232566 42.8969426547
-2.89559989778 42.8965199583
-2.89563454427 42.8964465209
-2.89570413677 42.8963026726
-2.89579520259 42.8966534213
-2.89599021214 42.8970859056
-2.89594017325 42.8970493968
                        </gml:posList>
                        </gml:LinearRing>
                        </gml:exterior>
            ...
            <base:Identifier>
            <base:localId>T3_CUA_3562</base:localId>
            <base:namespace>ES.LOCAL.CP</base:namespace>
            </base:Identifier>
            </cp:inspireId>
      <cp:label>T3_CUA_3562</cp:label>
      <cp:nationalCadastralReference>T3_CUA_3562</cp:nationalCadastralReference>
      </cp:CadastralParcel>
   </gml:featureMember>
