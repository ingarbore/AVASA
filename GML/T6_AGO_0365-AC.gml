...
<gml:FeatureCollection xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:cp="urn:x-inspire:specification:gmlas:CadastralParcels:3.0" xmlns:base="urn:x-inspire:specification:gmlas:BaseTypes:3.2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:x-inspire:specification:gmlas:CadastralParcels:3.0 http://inspire.ec.europa.eu/schemas/cp/3.0/CadastralParcels.xsd" gml:id="ES.LOCAL.CP">
   <gml:featureMember>
      <cp:CadastralParcel gml:id="ES.LOCAL.CP.T6_AGO_0365-AC">
         <cp:areaValue uom="m2">8.10027498399e-08</cp:areaValue>
         <cp:beginLifespanVersion xsi:nil="true" nilReason="other:unpopulated"></cp:beginLifespanVersion>
         <cp:geometry>
           <gml:MultiSurface gml:id="MultiSurface_ES.LOCAL.CP.T6_AGO_0365-AC" srsName="urn:ogc:def:crs:EPSG:4326"> 
                <gml:surfaceMember>
               <gml:Surface gml:id="Surface_ES.LOCAL.CP.T6_AGO_0365-AC.Polygon_1" srsName="urn:ogc:def:crs:EPSG:4326">
                  <gml:patches>
                    <gml:PolygonPatch>
                        <gml:exterior>
                        <gml:LinearRing>
                        <gml:posList srsDimension="2" count="5">
-2.28867491414 42.4368345123
-2.28908338145 42.4364379441
...
-2.28867491414 42.4368345123
            ...
            <base:Identifier>
            <base:localId>T6_AGO_0365-AC</base:localId>
            <base:namespace>ES.LOCAL.CP</base:namespace>
            </base:Identifier>
            </cp:inspireId>
      <cp:label>T6_AGO_0365-AC</cp:label>
      <cp:nationalCadastralReference>T6_AGO_0365-AC</cp:nationalCadastralReference>
      </cp:CadastralParcel>
   </gml:featureMember>
