...
<gml:FeatureCollection xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:cp="urn:x-inspire:specification:gmlas:CadastralParcels:3.0" xmlns:base="urn:x-inspire:specification:gmlas:BaseTypes:3.2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:x-inspire:specification:gmlas:CadastralParcels:3.0 http://inspire.ec.europa.eu/schemas/cp/3.0/CadastralParcels.xsd" gml:id="ES.LOCAL.CP">
   <gml:featureMember>
      <cp:CadastralParcel gml:id="ES.LOCAL.CP.T10_ALA_0028-A">
         <cp:areaValue uom="m2">271.679395794</cp:areaValue>
         <cp:beginLifespanVersion xsi:nil="true" nilReason="other:unpopulated"></cp:beginLifespanVersion>
         <cp:geometry>
           <gml:MultiSurface gml:id="MultiSurface_ES.LOCAL.CP.T10_ALA_0028-A" srsName="urn:ogc:def:crs:EPSG:25830"> 
                <gml:surfaceMember>
               <gml:Surface gml:id="Surface_ES.LOCAL.CP.T10_ALA_0028-A.Polygon_1" srsName="urn:ogc:def:crs:EPSG:25830">
                  <gml:patches>
                    <gml:PolygonPatch>
                        <gml:exterior>
                        <gml:LinearRing>
                        <gml:posList srsDimension="2" count="9">
654357.822071 4626153.51424
654360.157424 4626145.32551
654352.711998 4626148.82932
654341.465738 4626189.59115
654341.159419 4626190.70082
654345.493284 4626192.47882
654346.752963 4626190.99609
654356.069883 4626159.52871
654357.822071 4626153.51424
                        </gml:posList>
                        </gml:LinearRing>
                        </gml:exterior>
            ...
            <base:Identifier>
            <base:localId>T10_ALA_0028-A</base:localId>
            <base:namespace>ES.LOCAL.CP</base:namespace>
            </base:Identifier>
            </cp:inspireId>
      <cp:label>T10_ALA_0028-A</cp:label>
      <cp:nationalCadastralReference>T10_ALA_0028-A</cp:nationalCadastralReference>
      </cp:CadastralParcel>
   </gml:featureMember>
