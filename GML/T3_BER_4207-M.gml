...
<gml:FeatureCollection xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:cp="urn:x-inspire:specification:gmlas:CadastralParcels:3.0" xmlns:base="urn:x-inspire:specification:gmlas:BaseTypes:3.2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:x-inspire:specification:gmlas:CadastralParcels:3.0 http://inspire.ec.europa.eu/schemas/cp/3.0/CadastralParcels.xsd" gml:id="ES.LOCAL.CP">
   <gml:featureMember>
      <cp:CadastralParcel gml:id="ES.LOCAL.CP.T3_BER_4207-M">
         <cp:areaValue uom="m2">4.89017543399e-08</cp:areaValue>
         <cp:beginLifespanVersion xsi:nil="true" nilReason="other:unpopulated"></cp:beginLifespanVersion>
         <cp:geometry>
           <gml:MultiSurface gml:id="MultiSurface_ES.LOCAL.CP.T3_BER_4207-M" srsName="urn:ogc:def:crs:EPSG:4326"> 
                <gml:surfaceMember>
               <gml:Surface gml:id="Surface_ES.LOCAL.CP.T3_BER_4207-M.Polygon_1" srsName="urn:ogc:def:crs:EPSG:4326">
                  <gml:patches>
                    <gml:PolygonPatch>
                        <gml:exterior>
                        <gml:LinearRing>
                        <gml:posList srsDimension="2" count="7">
-2.88831989039 42.6754367593
-2.88768878916 42.6752266282
-2.88722535607 42.6749619893
-2.88727649466 42.6749841718
-2.88797609002 42.6752876329
-2.88798222041 42.675290292
-2.88831989039 42.6754367593
                        </gml:posList>
                        </gml:LinearRing>
                        </gml:exterior>
...
<gml:surfaceMember>
               <gml:Surface gml:id="Surface_ES.LOCAL.CP.T3_BER_4207-M.Polygon_2" srsName="urn:ogc:def:crs:EPSG:4326">
                  <gml:patches>
                    <gml:PolygonPatch>
                        <gml:exterior>
                        <gml:LinearRing>
...
-2.88831989039 42.6754367593
-2.88858815836 42.6755202614
-2.88883691437 42.6757027105
-2.88831989039 42.6754367593
                        </gml:posList>
                        </gml:LinearRing>
                        </gml:exterior>
            ...
            <base:Identifier>
            <base:localId>T3_BER_4207-M</base:localId>
            <base:namespace>ES.LOCAL.CP</base:namespace>
            </base:Identifier>
            </cp:inspireId>
      <cp:label>T3_BER_4207-M</cp:label>
      <cp:nationalCadastralReference>T3_BER_4207-M</cp:nationalCadastralReference>
      </cp:CadastralParcel>
   </gml:featureMember>
