...
<gml:FeatureCollection xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:cp="urn:x-inspire:specification:gmlas:CadastralParcels:3.0" xmlns:base="urn:x-inspire:specification:gmlas:BaseTypes:3.2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:x-inspire:specification:gmlas:CadastralParcels:3.0 http://inspire.ec.europa.eu/schemas/cp/3.0/CadastralParcels.xsd" gml:id="ES.LOCAL.CP">
   <gml:featureMember>
      <cp:CadastralParcel gml:id="ES.LOCAL.CP.T5_ROD_4800">
         <cp:areaValue uom="m2">2.05322126503e-08</cp:areaValue>
         <cp:beginLifespanVersion xsi:nil="true" nilReason="other:unpopulated"></cp:beginLifespanVersion>
         <cp:geometry>
           <gml:MultiSurface gml:id="MultiSurface_ES.LOCAL.CP.T5_ROD_4800" srsName="urn:ogc:def:crs:EPSG:4326"> 
                <gml:surfaceMember>
               <gml:Surface gml:id="Surface_ES.LOCAL.CP.T5_ROD_4800.Polygon_1" srsName="urn:ogc:def:crs:EPSG:4326">
                  <gml:patches>
                    <gml:PolygonPatch>
                        <gml:exterior>
                        <gml:LinearRing>
                        <gml:posList srsDimension="2" count="5">
-2.84735639354 42.5474365574
-2.84753889174 42.5475605865
-2.84769606529 42.5476674038
-2.84745282847 42.5476229909
-2.84735639354 42.5474365574
                        </gml:posList>
                        </gml:LinearRing>
                        </gml:exterior>
            ...
            <base:Identifier>
            <base:localId>T5_ROD_4800</base:localId>
            <base:namespace>ES.LOCAL.CP</base:namespace>
            </base:Identifier>
            </cp:inspireId>
      <cp:label>T5_ROD_4800</cp:label>
      <cp:nationalCadastralReference>T5_ROD_4800</cp:nationalCadastralReference>
      </cp:CadastralParcel>
   </gml:featureMember>
